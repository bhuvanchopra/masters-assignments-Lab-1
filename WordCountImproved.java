        ...
        public static class TokenizerMapper extends Mapper<LongWritable, Text, Text, LongWritable>{
                ...
                public void map(LongWritable key, Text value, Context context
                        ...
                        for(int i=0;i<stringarray.length;i++){
                                ...
                                stringg = stringg +  stringarray[i] + " ";
                        }


                        byte[] ptext = stringg.getBytes(ISO_8859_1);
                        String valuenew = new String(ptext, UTF_8);


                        StringTokenizer itr = new StringTokenizer(valuenew);
